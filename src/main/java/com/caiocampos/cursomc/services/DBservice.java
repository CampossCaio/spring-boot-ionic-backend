...
import com.caiocampos.cursomc.domain.enums.Perfil;
...
public class DBservice {
	...
	public void instanciateTesteDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null,"Maria Silva","caiocamposs141097@gmail.com","3799999999",TipoCliente.PESSOAFISICA,pe.encode("123456") );
		cli1.getTelefones().addAll(Arrays.asList("131144455","466363674"));
		
		Cliente cli2 = new Cliente(null,"Caio Campos","caiocampos141097@gmail.com","3378888889",TipoCliente.PESSOAFISICA,pe.encode("123456") );
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("474484888","955353756"));
		...
		Endereco e3 = new Endereco(null,"Avenida Doidda", "140", "Sala 600", "Centro", "5366666", cli2, c2);

...
--
-- Table structure for table `categoriadto`
--

DROP TABLE IF EXISTS `categoriadto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `categoriadto`
--

LOCK TABLES `categoriadto` WRITE;
/*!40000 ALTER TABLE `categoriadto` DISABLE KEYS */;
/*!40000 ALTER TABLE `categoriadto` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `cliente` VALUES (1,'3799999999','maria@gmail.com','Maria Silva',1);
...
INSERT INTO `endereco` VALUES (1,'Jardim','5336636','Apto 303','Rua Flores','300',1,1),(2,'Centro','53636366','Sala 800','Avenida Matos','105',2,1);
...
INSERT INTO `produto` VALUES (1,'Computador',2000),(2,'Impressora',800),(3,'Mouse',80),(4,'Mesa de escritório',300),(5,'Toalha',50),(6,'Colcha',200),(7,'Tv true color',1200),(8,'Roçadeira',800),(9,'Abajur',100),(10,'Pendente',180),(11,'Shampo',90);
...
INSERT INTO `telefone` VALUES (1,'466363674'),(1,'131144455');
...
-- Dump completed on 2019-08-07 19:38:45
